...
public class PHPEditor extends GenericAdmResource {
    ...
    public void processAction(HttpServletRequest request,
        ...
        if (code != null && !"".equals(code)) {
            try {
                if (fileName == null) {
                    fileName = UUID.randomUUID().toString().replaceAll("-", "") + ".php";
