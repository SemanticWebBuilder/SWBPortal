...
/**
 * Utileria para el envio de archivos al servidor. Class for send files to
 * server
 */
public class FileUpload {
	 ...
	 *             Signals that an I/O exception has occurred.
	 */
	public String getValues(String s) throws IOException {
		String params9 = s;
		String valTmp = null;
		CParameter cparam = null;
		for (int x = 0; x < parametros.size(); x++) {
			cparam = (CParameter) parametros.get(x);
