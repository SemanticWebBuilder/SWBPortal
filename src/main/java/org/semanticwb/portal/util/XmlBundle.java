...
/**
 * Objeto que maneja el lenguaje en la api de administración de recursos para la
 * utilización adecuada de xml's
 * <p>
 * Object that handles the language in the resources administration api for
 * correct use of xml's.
 * 
 * @author Infotec
 */
...
public class XmlBundle {
	...
	/** The log. */
	private static Logger LOG = SWBUtils.getLogger(XmlBundle.class);
	...
	private static void findBundleImpl(String baseName, Locale locale, ClassLoader loader) {
		try {
			...
			LOG.error("Error in XmlBundle while getting bundle", e);
		}
	}
