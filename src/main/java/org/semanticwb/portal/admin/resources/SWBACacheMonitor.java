...
public class SWBACacheMonitor extends GenericResource {
    ...
    public void doView(HttpServletRequest request, HttpServletResponse response,
        ...
        if (SWBPlatform.getEnv("wb/systemMonitor", "false").equals("true")) {
            ...
            out.println("    data.addColumn('number', '"+paramsRequest.getLocaleString("msgResXseg")+"');");
            out.println("    data.addColumn('number', '"+paramsRequest.getLocaleString("msgResCachedXSec")+"');");
            out.println("    data.addColumn('number', '"+paramsRequest.getLocaleString("msgResCacheLoaded")+"');");
            ...
            out.println("      vAxis: {title: '"+paramsRequest.getLocaleString("msgResCachedXSec")+"', titleTextStyle: {color:'#262626',bold:true,italic:false}, textStyle: {color: '#336799', fontSize:10}, minValue: 0, format: 'decimal', gridlines: {count: 10}},");
