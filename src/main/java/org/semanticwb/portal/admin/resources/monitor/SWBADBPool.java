    ...
    public void doView(HttpServletRequest request, HttpServletResponse response,
        ...
        if (selectedPool != null) {
            ...
            if (SWBPlatform.getEnv("wb/systemMonitor", "false").equals("true")) {
                ...
                out.println("    dataM.addColumn('datetime', 'Instante');");
                out.println("    dataM.addColumn('number', 'Total');");
                out.println("    dataM.addColumn('number', 'Libre');");
                out.println("    dataM.addColumn('number', 'Usada');");
                ...
                out.println("      vAxis: {title: 'Accesos', titleTextStyle: {color:'#262626',bold:true,italic:false}, textStyle: {color: '#336799', fontSize:10}, minValue: 0, format: 'decimal', gridlines: {count: 10}},");
                ...
                out.println("    dataT.addColumn('datetime', 'Instante');");
                ...
                out.println("      chartArea:{left:100,top:40, bottom:40, width:'75%',height:150},");
                out.println("      hAxis: {title: 'Hora del día', titleTextStyle: {color:'#262626',bold:true,italic:false}, textStyle: {color: '#336799', fontSize:10}, format: 'hh:mm:ss', gridlines: {count: 10}},");
                out.println("      vAxis: {title: 'milisegundos (ms)', titleTextStyle: {color:'#262626',bold:true,italic:false}, textStyle: {color: '#336799', fontSize:10}, minValue: 0, format: 'decimal', gridlines: {count: 10}},");
                out.println("      explorer: { actions: ['dragToZoom', 'rightClickToReset'], axis: 'horizontal', maxZoomIn:16}");
                out.println("    };");
                ...
                out.println("    dataS.addColumn('datetime', 'Instante');");
                ...
                out.println("      chartArea:{left:100,top:40, bottom:40, width:'75%',height:150},");
                out.println("      hAxis: {title: 'Hora del día', titleTextStyle: {color:'#262626',bold:true,italic:false}, textStyle: {color: '#336799', fontSize:10}, format: 'hh:mm:ss', gridlines: {count: 10}},");
                out.println("      vAxis: {title: 'Peticiones / seg.', titleTextStyle: {color:'#262626',bold:true,italic:false}, textStyle: {color: '#336799', fontSize:10}, minValue: 0, format: 'decimal', gridlines: {count: 10}},");
                out.println("      explorer: { actions: ['dragToZoom', 'rightClickToReset'], axis: 'horizontal', maxZoomIn:16}");
                out.println("    };");
