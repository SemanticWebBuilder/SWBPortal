...
public class SWBARule extends GenericResource {
	 ...
	 * 
	 * @param root
	 *            Root element to get definitions from
	 ...
	 * 
	 * @param ruleDef
	 *            JSON object for rule definition
	...
	/**
	 * Process requests to get rule configuration options (conditions, operators,
	 * values)
	 * 
	 * @param request
	 * @param response
