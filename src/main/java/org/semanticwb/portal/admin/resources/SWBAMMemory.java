    ...
    */    
    ...
    public void doView(HttpServletRequest request, HttpServletResponse response,
        ...
        if (SWBPlatform.getEnv("wb/systemMonitor", "false").equals("true")) {
            ...
            out.println("    data.addColumn('datetime','"+paramsRequest.getLocaleString("lblInstant")+"');");
            out.println("    data.addColumn('number',  '"+paramsRequest.getLocaleString("total")+"');");
            out.println("    data.addColumn('number',  '"+paramsRequest.getLocaleString("free")+"');");
            out.println("    data.addColumn('number',  '"+paramsRequest.getLocaleString("used")+"');");
            ...
            out.println("      title: '"+paramsRequest.getLocaleString("memoryMonitor")+". "+paramsRequest.getLocaleString("max")+": "+(Runtime.getRuntime().maxMemory()/1000000)+" (Mb)',");
            ...
            out.println("      vAxis: {title: '"+paramsRequest.getLocaleString("lblMemory")+"', titleTextStyle: {color:'#262626',bold:true,italic:false}, textStyle: {color:'#336799', fontSize:10}, baseline:0, minValue:0, format: 'decimal', gridlines: {count: 10}},");
            ...
            out.println("<fieldset>");
            url = paramsRequest.getActionUrl();
            url.setCallMethod(SWBResourceURL.Call_DIRECT);
            url.setParameter("gc", "1");
            out.println("    <button dojoType=\"dijit.form.Button\" onclick=\"location.href='"+url.toString()+"'\">" + paramsRequest.getLocaleString("gc") + "</button>");
            out.println("</fieldset>");
            out.println("<fieldset>");
            out.println("  <div class=\"swbform\">");
