...
//            ret.append("<li>Carga promedio: "+String.format("%1$3.4f", systemLoadAverage)+"</li>\n");
            ret.append(("<li>CPU Instant&aacute;neo: "+String.format("%1$3.4f", instantCPU)+"</li>\n"));
            ...
            ret.append(("<ul>\n<li>Sistema Operativo: "+osName+"</li>\n"));
            ret.append(("<li>Arquitectura: "+vmArch+"</li>\n"));
            ret.append(("<li>Procesadores: "+nCPUs+"</li>\n"));
            ret.append(("<li>Memoria Virtual Accesible: "+formatLong(commitedVirtualMem/1024)+" kbytes</li>\n"));
            ...
            ret.append(("<li>Deamon Threads: "+deamonTh+"</li>\n"));
            ret.append(("<li>Total Threads Iniciados: "+startedTh+"</li>\n"));
